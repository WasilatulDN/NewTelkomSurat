        ...
        <div>
            <form action="" method = "post" style="margin-left: 90px; margin-top: 50px; width: 30%; font-family:'GothamRounded-Medium';">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan Kode" name="" required>
                </div>

                <div class="form-group">
                    <label>Jenis Surat</label>

                    <input type="text" class="form-control" placeholder="Masukkan Jenis Surat" name="" required>
