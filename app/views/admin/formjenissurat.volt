...
<body>
    ...
    <div class="wrapper">
        ...
        <div>
            <form action="{{ url('admin/jenissurat') }}" method = "post" style="margin-left: 90px; margin-top: 50px; width: 30%; font-family:'GothamRounded-Medium';">
                <div class="form-group">
                    <label>Kode Jenis Surat</label>

                    <input type="text" class="form-control" placeholder="Masukkan Kode" name="kode" required>
                </div>

                <div class="form-group">
                    <label>Jenis Surat</label>

                    <input type="text" class="form-control" placeholder="Masukkan Jenis Surat" name="nama_surat" required>
