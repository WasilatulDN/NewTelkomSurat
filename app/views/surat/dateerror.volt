...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div>
                <h3 style="margin-top: 15%; text-align: center; font-weight: bold; font-family:'GothamRounded-Medium'; font-size: 30pt;">Tidak bisa generate nomor surat.</h3>
                <h5 style="margin: 0 auto; text-align: center; font-family:'GothamRounded-Medium';">Tidak dapat melakukan generate surat pada tanggal tersebut.<br> Periksa kembali pemilihan tanggal anda. Silahkan pilih tanggal lain.</h5>
